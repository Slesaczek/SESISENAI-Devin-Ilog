...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(FalhaExclusaoVeiculoComMultasException.class)
    public ResponseEntity<Object> handleFalhaExclusaoVeiculoComMultasException(FalhaExclusaoVeiculoComMultasException e) {
        Map<String, String> retorno = new HashMap<>();
