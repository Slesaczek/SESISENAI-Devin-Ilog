...
public class Ex09 {
    public static void main(String[] args) {
        /*Antigamente tinha um programa de televisão onde o apresentador chamava alguém da platéia
        ...
        Então, dada o array com a sequência abaixo (de 0 a 30), use a função 'for' para
        iterar sobre seus elementos e a cada múltiplo de 3 imprimir a palavra 'PIN', ou o próprio número caso contrário.
        */
